...
public enum Oauth: Endpoint {
    ...
    public struct TokenData: Encodable {
        ...
        public let redirectUri = ProboscisKit.unwrappedInfo.scheme
        public let code: String
        public let scope = ProboscisKit.unwrappedInfo.stringScopes
    }
        ...
        switch self {
            case let .authorize(clientId):
                return [
                    ...
                    .init(name: "redirect_uri", value: ProboscisKit.unwrappedInfo.scheme),
                    .init(name: "scope", value: ProboscisKit.unwrappedInfo.stringScopes),
                ]
            default:
                return nil
        }
...
public enum Apps: Endpoint {
    ...
    public func queryItems() -> [URLQueryItem]? {
        switch self {
            case .registerApp:
                return [
                    .init(name: "client_name", value: ProboscisKit.unwrappedInfo.appName),
                    .init(name: "redirect_uris", value: ProboscisKit.unwrappedInfo.scheme),
                    .init(name: "scopes", value: ProboscisKit.unwrappedInfo.stringScopes),
                    .init(name: "website", value: ProboscisKit.unwrappedInfo.aboutApp.absoluteString),
                ]
        }
    }
}

public enum AppScopes: String, Codable, CaseIterable {
    case read
    case write
    case follow
    case push
